        ...
        <div className="md:w-[58%] flex flex-col justify-center px-6 py-8 md:px-16 md:py-20 overflow-y-auto no-scrollbar">
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="flex gap-3 md:gap-5 items-start">
              <span className="inline-flex items-center justify-center px-2 md:px-3 py-1 bg-[#1B263B] text-white text-[10px] md:text-xs font-semibold rounded-[2px] w-[72px] md:w-[84px] shrink-0">
                일시
              </span>
